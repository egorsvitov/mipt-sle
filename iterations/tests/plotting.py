...
with open('by_iterations.txt', 'r') as f:
    for line in f.readlines():
        if (line != '\n'):
            [_ns, _simple_norms, _jacobi_norms, _gauss_seidel_norms] = [float(i) for i in line.split()]
            ns.append(_ns)
...
with open('by_time.txt', 'r') as f:
    for line in f.readlines():
        if (line != '\n'):
            [_tolerances, _simple_times, _jacobi_times, _gauss_seidel_times] = [float(i) for i in line.split()]
