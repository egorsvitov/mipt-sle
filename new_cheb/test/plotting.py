...
with open('by_iterations.txt', 'r') as f:
    for line in f.readlines():
        if (line != '\n'):
            [_ns, _simple_norms, _jacobi_norms, _gauss_seidel_norms, _cheb_norms, _new_cheb_norms, _fastest_grad_norms, _sym_GS_norms] = [float(i) for i in line.split()]
            ns.append(_ns)
...
with open('by_time.txt', 'r') as f:
    for line in f.readlines():
        if (line != '\n'):
            [_tolerances, _simple_times, _jacobi_times, _gauss_seidel_times, _cheb_times, _new_cheb_times, _fastest_grad_times, _sym_GS_times] = [float(i) for i in line.split()]
